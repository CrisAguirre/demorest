...
const routes: Routes = [
  { path: 'login', loadChildren: () => import('./features/auth/auth.module').then(m => m.AuthModule) },
  {
    path: '', canActivate: [AuthGuard], children: [
      ...
      { path: 'servicio', loadChildren: () => import('./features/servicio/servicio.module').then(m => m.ServicioModule), canActivate: [RoleGuard], data: { roles: ['admin'] } },
      { path: 'barra', loadChildren: () => import('./features/barra/barra.module').then(m => m.BarraModule), canActivate: [RoleGuard], data: { roles: ['admin'] } },
      { path: 'cocina', loadChildren: () => import('./features/cocina/cocina.module').then(m => m.CocinaModule), canActivate: [RoleGuard], data: { roles: ['admin'] } },
